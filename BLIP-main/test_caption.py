...
image_paths = os.listdir('F:\\car-detect\\dataset\\dataset_car\\VOC2007\\splits/')
for image_name in image_paths:
    if num > 10:
        break
    #num += 1
    image_path = os.path.join('F:\\car-detect\\dataset\\dataset_car\\VOC2007\\splits/',image_name)
    print(image_path)
