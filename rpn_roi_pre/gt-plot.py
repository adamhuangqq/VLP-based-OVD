...
if __name__ == '__main__':    
    ...
    image_path = '/root/code/datasets/COCO/VOC2007/JPEGImages/'
    annotation_path = '.temp_map_out/detection-results/'
    gt_annotation_path = '.temp_map_out/ground-truth/'
    save_path = '.temp_map_out/plot-detc/'
    save_path_gt = '.temp_map_out/plot-detc-gt/'
