...
from nets.frcnn_training_loss import (FasterRCNNTrainer, get_lr_scheduler,
                                 set_optimizer_lr, weights_init)
from utils.callbacks_ovd import EvalCallback, LossHistory
...
if __name__ == "__main__":
    ...
    #------------------------------------------------------------------#
    save_dir            = 'logs/voc/iou+l1+pos_ratio=0.75'
    #------------------------------------------------------------------#
