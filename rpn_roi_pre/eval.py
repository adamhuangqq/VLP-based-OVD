...
from utils.callbacks_ovd_eval import EvalCallback, LossHistory
...
if __name__ == "__main__":
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    #model_path      = '/home/huangqiqiang/docker/code/rpn_roi_pre/logs/voc/iou>0.55<0.45,banL1LOSS/ep060-loss1.162-val_loss2.158.pth'
    #model_path      = '/home/huangqiqiang/docker/code/rpn_roi_pre/logs/voc/iou>0.55<0.45,banL1LOSS/ep080-loss0.933-val_loss2.155.pth'
    #model_path      = '/home/huangqiqiang/docker/code/rpn_roi_pre/logs/voc/iou>0.55<0.45,iouLOSS/ep100-loss0.651-val_loss0.982.pth'
    model_path      = 'logs/car/ep100-loss0.450-val_loss0.736.pth'
    #------------------------------------------------------#
    ...
    if Cuda:
        model_aval = torch.nn.DataParallel(model_eval)
        cudnn.benchmark = True
        model_aval = model_eval.cuda()
    with open(val_annotation_path, encoding='utf-8') as f:
        val_lines   = f.readlines()
    
    log_dir = 'logs/voc/'
    eval_callback   = EvalCallback(model_eval, input_shape, class_names, num_classes, val_lines, log_dir, Cuda, \
                                        eval_flag=eval_flag, period=eval_period)
    
    eval_callback.on_epoch_end(1)
