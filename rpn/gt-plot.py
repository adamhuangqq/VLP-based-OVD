...
if __name__ == '__main__':    
    ...
    image_path = 'D:/OVD/datasets/VOCdevkit/VOC2007/JPEGImages/'
    annotation_path = 'results/ori/.temp_map_out4/detection-results/'
    gt_annotation_path = 'results/ori/.temp_map_out4/ground-truth/'
    save_path = 'results/ori/.temp_map_out4/plot-detc/'
    save_path_gt = 'results/ori/.temp_map_out4/plot-detc-gt/'
