...
def propasal_select(gt_path, detc_path, save_path, IOU = 0.7):
    ...
    for file in file_list:
        ...
        if len(keep) > 0:
            ...
            detc_bbox[:,0] = gt_bbox[argmax_ious,0]
            #print(detc_bbox[:,0])
            with open(save_path+file,'w') as w:
...
if __name__ == '__main__':
    ...
    #第二步，找到最符合的proposal
    gt_path = 'proposal_select/ground-truth/'
    detc_path = 'proposal_select/detection-results/'
    save_path = 'proposal_select/proposal_final/'
