...
from nets.rpn_training_ori import (RPNTrainer, get_lr_scheduler,
                                 set_optimizer_lr, weights_init)
from utils.callbacks_rpn_ori import EvalCallback, LossHistory
from utils.dataloader import FRCNNDataset, frcnn_dataset_collate
from utils.utils import (get_classes, seed_everything, show_config,
                         worker_init_fn)
from utils.utils_fit_rpn_ori import fit_one_epoch
...
if __name__ == "__main__":
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    model_path      = 'logs/ep100-loss0.065-val_loss0.065.pth'
    #------------------------------------------------------#
    ...
    eval_callback.on_epoch_end(100)
